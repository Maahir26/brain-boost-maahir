...
let db
const contractTxId = "T0IoqVUtvdWKN4gRT2oJIPGupwPgHaz05XX6O-1h1nA"
...
export default function App() {
    ...
    const deleteTask = async id => {
        await db.delete("Questions", id, user)
        await getQuestions()
    }
    ...
    const NewTask = () => (
        <Flex mb={4}>
            ...
            <Flex
                ...
                onClick={async () => {
                    if (!/^\s*$/.test(questions.current)) {
                        await addTask(questions.current)
                        questions.current = ""
                    }
                }}
            >
